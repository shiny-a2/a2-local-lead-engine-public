...
class Phase8ManualReviewItem(TimestampMixin, Base):
    __tablename__ = "phase8_manual_review_items"
    ...
    review_type: Mapped[Phase8ReviewType] = mapped_column(Enum(Phase8ReviewType, native_enum=False))
