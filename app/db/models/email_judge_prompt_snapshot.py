...
class EmailJudgePromptSnapshot(Base):
    __tablename__ = "email_judge_prompt_snapshots"
    id: Mapped[int] = mapped_column(primary_key=True)
    email_judge_run_id: Mapped[int] = mapped_column(ForeignKey("email_judge_runs.id"))
    template_id: Mapped[int] = mapped_column(ForeignKey("email_judge_prompt_templates.id"))
